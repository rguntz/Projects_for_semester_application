...
int bot_simulation(int tavli[4][13], int couleur){
    ...
    else if( (function_is_every_chercker_in_last_box_O(tavli2) == 1) && (function_is_every_chercker_in_last_box_X(tavli2) == 1) ){
        printf("Tous les deux gagnant\n"); 
    }
